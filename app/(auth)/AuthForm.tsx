export default function AuthForm({ name, action, error, children, switchLabel, switchLink }: {
    ...
    return (
        <form action={action} className='flex flex-col gap-2 w-96 mt-5 mx-auto max-w-full px-2 py-5 bg-white shadow rounded'>
            ...
            <p className='text-center'>{switchLabel} <span className='text-blue-500 underline'>{switchLink}</span></p>
